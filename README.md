 ...
 * Analyzing patterns, trends, and summaries from data
The goal of this project is to demonstrate my SQL querying skills and my ability to think analytically using data.
 ...
 * SQL Script File (.sql)
 Contains all the queries written for solving analytical questions.
 * Presentation / Documentation (if included)
 Explains the problem statements, queries, and outputs in a structured way.
